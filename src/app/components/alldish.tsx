...
export default function FoodsByCategory() {
  ...
  const allFoods = categoriesWithFoods
  ...
  return (
    <div className="p-4 bg-gray-100 max-w-[900px] w-full m-auto rounded-2xl">
      ...
      {selectedCategory === "all" ? (
            ...
            {allFoods.map((food) => (
              ...
              >
                ...
                <div className="flex justify-between items-center mt-2">
                  <span className="text-red-500 truncate w-[75%] hover:overflow-visible hover:whitespace-normal">
                    {food.foodName}
                  </span>
        ...
        //end categorior huvaagdsan hesgig avchirna
        <div className="p-4 bg-gray-100 max-w-[900px] w-full m-auto rounded-2xl">
          <h2 className="text-xl font-bold mb-4">Foods by Category</h2>
                      ...
                      >
                        ...
                        <button
                          ...
                          onClick={(e) => {
                            ...
                            e.preventDefault();
                            setDropdown(
                              dropdown === food._id ? null : food._id
                            );
                          }}
                        >
                          <PenIcon className="text-red-500 w-5 h-5" />
